...
const features = [
  {
    ...
    desc: "Track every phase from planning to delivery",
    color: "#3b82f6",
  },
  {
    icon: Zap,
    label: "AI insights",
    desc: "Claude AI reviews, plans, and flags risks",
    color: "#8b5cf6",
  },
  {
    icon: Shield,
    label: "Team governance",
    desc: "Full audit trail with checkpoint decisions",
    color: "#06b6d4",
  },
  {
    icon: TrendingUp,
    label: "Progress tracking",
    desc: "Milestones and timebox dashboards live",
    color: "#10b981",
  },
];
...
export default function LoginPage() {
  ...
  function handleEmailChange(val: string) {
    ...
    if (rememberMe)
      try {
        localStorage.setItem(CACHE_EMAIL_KEY, val);
      } catch {}
  }
  ...
  return (
    <div className="h-screen w-screen overflow-hidden flex font-sans">
      ...
      <aside
        ...
        style={{
          background:
            "linear-gradient(140deg, #080d1a 0%, #111040 45%, #0d2540 100%)",
        }}
      >
        {/* ── Animated orbs ── */}
        ...
        >
          <div className="flex items-center gap-3.5">
            ...
            <div>
              ...
              <p className="text-blue-300/80 text-[10px] font-bold tracking-[0.16em] uppercase leading-tight">
                FarmwiseAI
              </p>
            </div>
          </div>
        ...
        >
          <div className="mb-9">
            ...
            >
              ...
              <span className="text-blue-300 text-[11px] font-semibold tracking-wide">
                CEO Command Center
              </span>
            </div>
            ...
            <p className="text-slate-400 text-base leading-relaxed max-w-xs">
              AI-powered project management built for FarmwiseAI. Every decision
              tracked, every deliverable reviewed.
            </p>
          </div>
          ...
          <div className="grid grid-cols-2 gap-3">
            {features.map(({ icon: Icon, label, desc, color }, i) => (
              ...
              >
                ...
                <p className="text-white text-[11px] font-bold leading-tight mb-1">
                  {label}
                </p>
        ...
        >
          ...
          >
            <div
              className="h-9 w-9 rounded-full flex items-center justify-center text-white text-[11px] font-bold shrink-0 shadow-glow-blue"
      ...
      ═══════════════════════════════════════════════════════════ */}
      {/* Mobile/tablet can scroll (hero + form stack); on desktop the form is
          short enough to always fit, so lock scrolling and center it. */}
      <main className="flex-1 h-full flex flex-col overflow-y-auto lg:overflow-hidden relative">
        ...
        >
          <div
            className="animate-blob absolute -top-32 -right-20 w-[360px] h-[360px] rounded-full"
            style={{
              background:
          ...
          />
          <div
            className="animate-blob-delay-1 absolute top-1/3 -left-16 w-72 h-72 rounded-full"
            style={{
              background:
                "radial-gradient(circle,rgba(139,92,246,0.22) 0%,transparent 65%)",
            }}
          />
          <div
            className="animate-blob-delay-2 absolute bottom-8 right-1/4 w-64 h-64 rounded-full"
            style={{
              background:
                "radial-gradient(circle,rgba(6,182,212,0.18) 0%,transparent 65%)",
            }}
        ...
        >
          ...
          <p className="text-blue-300/80 text-[10px] font-bold tracking-[0.16em] uppercase mt-0.5">
            FarmwiseAI
          </p>
        ...
        >
          ...
          <p className="text-slate-300 text-sm md:text-base font-medium mb-4 max-w-lg">
            AI-powered command center — every decision tracked, every
        ...
        ════════════════════════════════════════════════ */}
        <div className="flex-1 flex items-center justify-center px-4 py-6 sm:px-8 sm:py-10 lg:py-6 relative z-10">
    ...
    <>
      ...
      <form onSubmit={p.onSubmit} className="space-y-4">
        ...
        <div className="flex items-center justify-between pt-0.5">
          <button
            type="button"
            onClick={p.onToggleRemember}
            className="flex items-center gap-2 group"
            aria-pressed={p.rememberMe}
          >
            <span
        ...
        {p.error && (
          <div
            className="flex items-center gap-2.5 px-3.5 py-3 rounded-xl animate-fade-in-up"
            style={{
